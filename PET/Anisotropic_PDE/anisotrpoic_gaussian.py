...
def add_gaussian_noise(image, noise_percent): ## noise_percent is the percentage of the signal's RMS to be used as noise standard deviation.
    ...
    return noisy
noisy = add_gaussian_noise(image, noise_percent=30)
...
plt.tight_layout()
plt.savefig("comparison_gaussian.png", dpi=300)
print("IMAGE FILTERED AND SAVED AS \"comparison.png\".")
...
print(f"Relative RMS Noise (%): {noise_percentage:.2f}%")